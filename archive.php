	...
	<div class="row-fluid">
		...
		<?php if( have_posts() ){ ?>
			...
			if( empty($category_title) ){
				$category_title= __('archive', PHANTASMACODE_MARIANIAC_THEME);
			}
			?>
			<h1><?php _e("All entries in ", PHANTASMACODE_MARIANIAC_THEME); ?>
			<span class="highlight"><?php echo ucfirst($category_title); ?></span></h1>
			<?php 
			global $wp_query;
			$ct= 1;
